...
function ProductList() {
    ...
    const [addedToCart, setAddedToCart] = useState({}); // State for Cart
            ...
            <div style={styleObjUl}>
                ...
                <div>
                    <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        ...
                        <div className='cart_quantity_count'>{calculateCartQuantity(cartItems)}</div>
                        </h1>
                    </a>
                </div>
            </div>
                        ...
                        {category.plants.map((plant, pIndex) => {
                            ...
                            return (
                                <div className='product-card' key={pIndex}>
                                    ...
                                    <button className={InCart ? 'product-button added-to-cart' : 'product-button'} disabled={InCart} onClick={() => handleAddToCart(plant)}>
